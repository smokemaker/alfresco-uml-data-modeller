...
public class SdocPreferencePage
	extends FieldEditorPreferencePage
	implements IWorkbenchPreferencePage {

	public SdocPreferencePage() {
		super(GRID);
		setPreferenceStore(SdocCodegenPlugin.getDefault().getPreferenceStore());
		setDescription("Sdoc source code generator");
	}
...
*/		addField(
			new BooleanFieldEditor(
				PreferenceConstants.P_SELECT_ALL_NAMESPACES,
				"Select all namespaces to generate",
				getFieldEditorParent()));

		addField(
			new BooleanFieldEditor(
				PreferenceConstants.P_SKIP_NAMESPACE_SELECTION,
