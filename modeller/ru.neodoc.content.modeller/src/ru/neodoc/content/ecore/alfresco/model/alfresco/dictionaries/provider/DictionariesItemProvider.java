...
/**
 * This is the item provider adapter for a {@link ru.neodoc.content.ecore.alfresco.model.alfresco.dictionaries.Dictionaries} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DictionariesItemProvider
	 ...
	 * @generated
	 */
	public DictionariesItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DictionariesPackage.Literals.DICTIONARIES__DICTIONARIES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Dictionaries"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_Dictionaries_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Dictionaries.class)) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DictionariesPackage.Literals.DICTIONARIES__DICTIONARIES,
				 DictionariesFactory.eINSTANCE.createDictionary()));
	}
