 ...
 * @generated
 */
public class DictionariesAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public DictionariesAdapterFactory() {
	 ...
	 * @generated
	 */
	protected DictionariesSwitch<Adapter> modelSwitch =
		new DictionariesSwitch<Adapter>() {
			@Override
			...
			@Override
			public Adapter caseDictionaries(Dictionaries object) {
				return createDictionariesAdapter();
			}
			@Override
			public Adapter caseBaseNamespace(BaseNamespace object) {
				return createBaseNamespaceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ru.neodoc.content.ecore.alfresco.model.alfresco.dictionaries.Namespace <em>Namespace</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ru.neodoc.content.ecore.alfresco.model.alfresco.dictionaries.Dictionary <em>Dictionary</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ru.neodoc.content.ecore.alfresco.model.alfresco.dictionaries.Dictionaries <em>Dictionaries</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ru.neodoc.content.ecore.alfresco.model.alfresco.dictionaries.BaseNamespace <em>Base Namespace</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createBaseNamespaceAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ru.neodoc.content.ecore.alfresco.model.alfresco.dictionaries.Import <em>Import</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
