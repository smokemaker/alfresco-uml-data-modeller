...
public class ExportToXMLHandler2 extends AbstractAlfrescoHandler {
...
*/				
				UML2XMLGenerator generator = new UML2XMLGenerator(model, location);
				generator.setParentShell(this.shell);
