...
import ru.neodoc.content.codegen.sdoc.generator.GenerationStatusReporter;
import ru.neodoc.content.codegen.sdoc.generator.SdocGenerationManager;
...
*/		
	...
	protected void internaleRefresh() {
		...
		generationManager = new SdocGenerationManager(codegenManager);
	...
	protected void appendToLog(String value, boolean async) {
		if (async) {
	...
	protected void setProgress(int value, boolean async) {
		if (async) {
			Display.getDefault().asyncExec(new Runnable() {
...
/*		container.addPaintListener(new PaintListener() {
	...
	protected class Page5StatusReporter implements GenerationStatusReporter {
		...
		@Override
		public void totalUnits(int count) {
			if (useDirectAccess) {
